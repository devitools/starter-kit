<template>
  ...
  >
    <QHeader
      v-if="!modal"
      elevated
      class="DashboardLayout__header bg-primary"
    >
    ...
    >
      ...
      >
        <small class="float-left"><i>&copy; Hellix · {{ year }}</i></small>
...
.DashboardLayout {
  ...
  .DashboardLayout__header {
    // background-image: linear-gradient(60deg, #f1fdfd 0%, #eafffe 20%, #72c6c4 60%, #35bab5 100%);
